return {
  {
    ...
    --stylua: ignore
    keys = {
      { "<LocalLeader>a", function() require("harpoon"):list():add() end, desc = "Add Location" },
      ...
      { "<LocalLeader>d", function() require("harpoon"):list():remove() end, desc = "Remove Location" },
      ...
      { "<LocalLeader>l", function() local harpoon = require("harpoon") harpoon.ui:toggle_quick_menu(harpoon:list()) end, desc = "List locations" },
    },
  },
}
